...
_BGM_TIMERHOOK proc far
	...
	mov	AX,intdiv
	add	AX,4
	cmp	AX,glb.SGLB.tval
	mov	intdiv,AX
	jbe	short END_AT
	mov	AX,glb.SGLB.tval
	inc	AX
	sub	intdiv,AX
	jmp	short GO
	EVEN
...
GO:
	...
	;曲制御
	cmp	glb.SGLB.tcnt,TCNTMAX
	jne	short CHECK_MANAGE_SOUND
	xor	AX,AX
	mov	glb.SGLB.tcnt,AX
	cmp	glb.SGLB.rflg,ON
...
even
CHECK_MANAGE_SOUND:
	test	glb.SGLB.tcnt,3
	jne	short END_MANAGE_BGM
	cmp	glb.SGLB.effect,ON
	jne	short END_MANAGE_BGM
