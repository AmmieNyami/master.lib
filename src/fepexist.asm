...
KKfunc	proc	near
	...
	mov	Funcbuf.Funcparm.wFunc,CX
	mov	Funcbuf.Funcparm.wMode,AX
	xor	BX,BX
	mov	word ptr Funcbuf.Funcparm.lpKkname,BX
	mov	word ptr Funcbuf.Funcparm.lpKkname+2,BX
	mov	word ptr Funcbuf.Funcparm.lpDataparm,BX
	mov	word ptr Funcbuf.Funcparm.lpDataparm+2,BX
	mov	word ptr Funcbuf.Funcparm.Reserved,BX
	mov	word ptr Funcbuf.Funcparm.Reserved+2,BX
	push	SS
	lea	AX,Funcbuf
	push	AX
	call	MsKanjiAPIEntry		; MS-KANJIの呼び出し
	mov	AX,Funcbuf.Funcparm.wMode
KKfunc_done:
	mov	SP,BP
	pop	BP
	ret
