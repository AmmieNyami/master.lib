...
;		call	PFOPEN Pascal,offset DGROUP:[parfilename],DI
	...
	mov	pf,AX
	mov	ES,AX
	mov	ES,ES:[PFILE.pf_bf]
	mov	AX,ES:[BFILE.b_hdl]	; pf->bf->handle
	mov	handle,AX
	jmp	_OK
...
_MoveFilePointer:
	...
	mov	ES,pf
	mov	DX,word ptr ES:[PFILE.pf_osize]
	mov	CX,word ptr ES:[PFILE.pf_osize+2]
	sub	DX,word ptr ES:[PFILE.pf_loc]
	sbb	CX,word ptr ES:[PFILE.pf_loc+2]
	jmp	short i_seek
